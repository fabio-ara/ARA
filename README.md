...
- [`METODO_DE_TRABALHO.md`](METODO_DE_TRABALHO.md): método de pesquisa, decisão e documentação;
- [`BACKLOG.yaml`](BACKLOG.yaml): backlog canônico do projeto;
- [`DECISOES.md`](DECISOES.md): registro das decisões aprovadas.
